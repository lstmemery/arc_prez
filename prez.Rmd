...
<div id="left">
- If the real world is a chaotic system, we need to optimize adaptability
- DeepBlue didn't get us much closer to AGI
- Neither did the latest reinforcement learning algoirthms
...
- Example: OpenAI Five was brittle to exploits
</div>
...
- To compare intelligence we need to control for experience, priors and difficulty of the task
- Some human priors:
...
- Current ML lack these priors but have hard-coded knowledge
...
- Agentness
    - Some objects act **contingently** and **reciprocally**
